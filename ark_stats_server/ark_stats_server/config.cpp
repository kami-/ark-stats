...
class Extended_PreInit_EventHandlers {
    class ArkStatsServer {
        init = "[] call compile preProcessFileLineNumbers 'x\ark\addons\ark_stats_server\stats_preinit.sqf';";
    };
};

class Extended_PostInit_EventHandlers {
    class ArkStatsServer {
        init = "[] call compile preProcessFileLineNumbers 'x\ark\addons\ark_stats_server\stats_postinit.sqf';";
    };
};